...
func (c *ChainConfig) GetFeePoolContractAddress() common.Address {
	if c.ChainID == nil {
		return common.HexToAddress("0xEaCA46260024f4b5a76fccCCa85716B626888361") // Return default address if ChainID is nil (calculated from test mnemonic)
	}

	switch c.ChainID.Uint64() {
	case 28802: // Incentiv Testnet
		return common.HexToAddress("0xDCe91614dDf6665d93105D5aCDdaDC02bc64Ed45") // FeeDistributor Proxy address for Incentiv Testnet
	case 24101: // Incentiv Mainnet
		return common.HexToAddress("0x9a86f26E7eC81A9e4d97bE2200fa7b66A82046B2") // FeeDistributor Proxy address for Incentiv Mainnet
	default:
		return common.HexToAddress("0xEaCA46260024f4b5a76fccCCa85716B626888361") // Return default address for unknown networks (calculated from test mnemonic)
	}
}
