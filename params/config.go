...
var (
	...
	IncentivTestnetGenesisHash = common.HexToHash("0xf15fe9edb0b1688877db5ccd8a549a619d97f14a22f3d328517aecb5aa37cb4f")
)
...
var (
	...
	IncentivTestnetChainConfig = &ChainConfig{
		...
		BerlinBlock:                   big.NewInt(0),
		LondonBlock:                   big.NewInt(0),
		FeePoolBlock:                  big.NewInt(97000),
		ArrowGlacierBlock:             nil,
		GrayGlacierBlock:              nil,
		FastBlock:                     big.NewInt(97000),
		ZeroRewardBlock:               big.NewInt(97000),
