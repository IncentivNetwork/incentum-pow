...
var (
	...
	rpcFlags = []cli.Flag{
		...
		utils.HTTPDebugProfileFlag,
		utils.HTTPAllowUnsafeDebugFlag,
		utils.HTTPBatchLimitFlag,
		utils.HTTPDebugTraceMaxConcurrencyFlag,
		utils.WSEnabledFlag,
		...
		utils.WSDebugProfileFlag,
		utils.WSAllowUnsafeDebugFlag,
		utils.WSBatchLimitFlag,
		utils.WSDebugTraceMaxConcurrencyFlag,
...
`)
	...
	if ctx.String(utils.SyncModeFlag.Name) != "light" && !ctx.IsSet(utils.CacheFlag.Name) && !ctx.IsSet(utils.NetworkIdFlag.Name) {
		...
		if !ctx.IsSet(utils.SepoliaFlag.Name) &&
			...
			!ctx.IsSet(utils.IncentivTestnetFlag.Name) &&
			!ctx.IsSet(utils.IncentivDevnetFlag.Name) &&
