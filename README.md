...
**Key Features:**
- **Timelock Security**: Incentiv mainnet deployment uses a 24-hour delay between proposal and execution (deployment-time immutable minimum; devnet may use a shorter value)
