...
| `DPoWTime` | 1781182800 (2026-06-11 13:00:00 UTC) | `ChainConfig` activation timestamp (Unix seconds); pinned in the released mainnet binary from DPOW-008-7 (timestamp switch hotfix). |
